...
public enum DataMenuItem {
	...
	NORMAL(DataMenuType.HORSE_TYPE, PetData.NORMAL, Material.HAY_BLOCK, 1, (short) 0, "Normal", "Horse Type"),
	DONKEY(DataMenuType.HORSE_TYPE, PetData.DONKEY, Material.CHEST, 1, (short) 0, "Donkey", "Horse Type"),
	MULE(DataMenuType.HORSE_TYPE, PetData.MULE, Material.CHEST, 1, (short) 0, "Mule", "Horse Type"),
	ZOMBIE(DataMenuType.HORSE_TYPE, PetData.ZOMBIE, Material.ROTTEN_FLESH, 1, (short) 0, "Zombie", "Horse Type"),
	SKELETON(DataMenuType.HORSE_TYPE, PetData.SKELETON, Material.BOW, 1, (short) 0, "Skeleton", "Horse Type"),
	
	WHITE_HORSE(DataMenuType.HORSE_VARIANT, PetData.WHITE, Material.WOOL, 1, (short) 0, "White", "Horse Variant"),
	CREAMY_HORSE(DataMenuType.HORSE_VARIANT, PetData.CREAMY, Material.WOOL, 1, (short) 4, "Creamy", "Horse Variant"),
	CHESTNUT_HORSE(DataMenuType.HORSE_VARIANT, PetData.CHESTNUT, Material.STAINED_CLAY, 1, (short) 8, "Chestnut", "Horse Variant"),
	BROWN_HORSE(DataMenuType.HORSE_VARIANT, PetData.BROWN, Material.WOOL, 1, (short) 12, "Brown", "Horse Variant"),
	BLACK_HORSE(DataMenuType.HORSE_VARIANT, PetData.BLACK, Material.WOOL, 1, (short) 15, "White", "Horse Variant"),
	GRAY_HORSE(DataMenuType.HORSE_VARIANT, PetData.GRAY, Material.WOOL, 1, (short) 7, "Gray", "Horse Variant"),
	DARKBROWN_HORSE(DataMenuType.HORSE_VARIANT, PetData.DARKBROWN, Material.STAINED_CLAY, 1, (short) 7, "Dark Brown", "Horse Variant"),
	
	NONE(DataMenuType.HORSE_MARKING, PetData.NONE, Material.LEASH, 1, (short) 0, "None", "Horse Marking"),
	SOCKS(DataMenuType.HORSE_MARKING, PetData.SOCKS, Material.LEASH, 1, (short) 0, "White Socks", "Horse Marking"),
	WHITE_PATCH(DataMenuType.HORSE_MARKING, PetData.WHITEPATCH, Material.LEASH, 1, (short) 0, "White Patch", "Horse Marking"),
	WHITE_SPOTS(DataMenuType.HORSE_MARKING, PetData.WHITESPOT, Material.LEASH, 1, (short) 0, "White Spots", "Horse Marking"),
	BLACK_SPOTS(DataMenuType.HORSE_MARKING, PetData.BLACKSPOT, Material.LEASH, 1, (short) 0, "Black Spots", "Horse Marking"),
