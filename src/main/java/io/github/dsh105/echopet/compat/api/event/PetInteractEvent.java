...
/**
 * Called when a {@link Player} interacts with a {@link io.github.dsh105.echopet.api.pet.Pet}
 */
...
public class PetInteractEvent extends Event implements Cancellable {
     ...
     *
     * @return the {@link io.github.dsh105.echopet.compat.api.event.PetInteractEvent.Action} of the event
     */
