...
public enum AdminHelpPage {
    ...
    GENERAL(1, ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " <player> <type>:[data],[data];[name]",
            ...
            ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " <player> <type>:[data],[data];[name] <mount>:[data],[data];[name]",
            ...
            ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " name <player> <name>",
            ...
            ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " remove <player>",
            ChatColor.YELLOW + "    - Remove a Player's current pet.",
            ChatColor.DARK_RED + "    - Permission: echopet.petadmin.remove"),

    MOUNT(2, ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " mount <player> <type>:[data],[data];[name]",
            ChatColor.YELLOW + "    - Changes the mount type of a Player's current pet.",
            ChatColor.YELLOW + "    - Each data value is separated by a comma.",
            ChatColor.YELLOW + "    - Pet names can be entered using a semi-colon.",
            ChatColor.DARK_RED + "    - Permission: echopet.petadmin.type.<type>",

            ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " name <player> mount <name>",
            ChatColor.YELLOW + "    - Set the name tag of a Player's pet's mount.",
            ChatColor.YELLOW + "    - Names can be more than one word, but no longer than 64 characters.",
            ChatColor.DARK_RED + "    - Permission: echopet.petadmin.name",

            ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " mount <player> remove",
            ChatColor.YELLOW + "    - Remove a Player's pet's current mount.",
            ChatColor.DARK_RED + "    - Permission: echopet.petadmin.remove"),

    DEFAULT(3, ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " list",
            ChatColor.YELLOW + "    - Lists available pet types.",
            ChatColor.DARK_RED + "    - Permission: echopet.petadmin.list",

            ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " info <player>",
            ChatColor.YELLOW + "    - Provides info on a Player's current pet.",
            ChatColor.DARK_RED + "    - Permission: echopet.petadmin.info",

            ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " default <player> set <type>:[data],[data] [mount]:[data],[data]",
            ...
            ChatColor.GOLD + "/" + EchoPet.getInstance().adminCmdString + " default <player> set current",
