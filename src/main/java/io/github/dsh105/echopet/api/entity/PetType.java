...
public enum PetType {
    ...
    SKELETON("CraftSkeleton", 51, "Skeleton Pet", 20D, 5D, EntityType.SKELETON, PetData.WITHER),
    ...
    PetType(String classIdentifier, int registrationId, String defaultName, double maxHealth, double attackDamage, EntityType entityType, PetData... allowedData) {
        ...
        this.petClass = ReflectionUtil.getClass("io.github.dsh105.echopet.api.entity.pet.type." + classIdentifier + "Pet");
    ...
    public IEntityPet getNewEntityPetInstance(Object world, Pet pet) {
        return new SafeConstructor<IEntityPet>(this.entityClass, ReflectionUtil.getNMSClass("World"), Pet.class).newInstance(world, pet);
    }
    ...
    public Pet getNewPetInstance(String owner, IEntityPet entityPet) {
        return new SafeConstructor<Pet>(this.petClass, String.class, ReflectionUtil.getVersionedClass("entity.EntityPet")).newInstance(owner, entityPet);
    }
