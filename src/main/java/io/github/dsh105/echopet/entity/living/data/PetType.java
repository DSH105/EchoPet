...
public enum PetType {
    ...
    PetType(Class<? extends EntityLivingPet> entityClass, Class<? extends LivingPet> craftClass, int registrationId, String defaultName, int maxHealth, double attackDamage, EntityType entityType, PetData... allowedData) {
