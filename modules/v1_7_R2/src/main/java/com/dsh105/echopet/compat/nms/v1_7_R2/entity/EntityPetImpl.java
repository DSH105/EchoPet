...
import com.dsh105.echopet.compat.nms.v1_7_R2.entity.ai.PetGoalFloatImpl;
import com.dsh105.echopet.compat.nms.v1_7_R2.entity.ai.PetGoalFollowOwnerImpl;
import com.dsh105.echopet.compat.nms.v1_7_R2.entity.ai.PetGoalLookAtPlayerImpl;
...
public abstract class EntityPetImpl extends EntityCreature implements IAnimal, EntityPet {
    ...
    public void setPathfinding() {
        try {
            ...
            EchoPet.LOG.console(Level.WARNING, "Pet AI not completed!");
            e.printStackTrace();
        }
    }
    ...
    public void e(float sideMot, float forwMot) {
        ...
        if (FIELD_JUMP != null && this.passenger != null) {
            if (PetSettings.CAN_FLY.getValue(getPet().getPetType().storageName())) {
                try {
                ...
                try {
                    ...
                    "Failed to allow pet jumping for " + getPlayerOwner().getName() + "\'s pet.");
                    e.printStackTrace();
                }
            }
        }
