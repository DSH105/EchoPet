...
import io.github.dsh105.echopet.compat.api.entity.type.pet.ISlimePet;
...
public class CraftSlimePet extends CraftPet implements Slime {
    ...
    public CraftSlimePet(EntityPet entity) {
        super(entity);
    }
    ...
    public int getSize() {
        IPet p = this.getPet();
        if (p instanceof ISlimePet) {
            return ((ISlimePet) p).getSize();
        }
        return 0;
    }
