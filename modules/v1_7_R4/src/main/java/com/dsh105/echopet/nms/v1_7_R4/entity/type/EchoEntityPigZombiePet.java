...
import com.dsh105.echopet.api.entity.entitypet.type.EntityPigZombiePet;
import com.dsh105.echopet.api.entity.pet.type.PigZombiePet;
...
public class EchoEntityPigZombiePet extends EntityPigZombie implements IAnimal, EchoEntityPetHandle, EntityPigZombiePet {

    private EntityPetModifier<PigZombiePet> modifier;

    public EchoEntityPigZombiePet(World world) {
        super(world);
    }

    public EchoEntityPigZombiePet(World world, PigZombiePet pet) {
        super(world);
    ...
    @Override
    public PigZombiePet getPet() {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<PigZombiePet> getModifier() {
        return modifier;
    }
