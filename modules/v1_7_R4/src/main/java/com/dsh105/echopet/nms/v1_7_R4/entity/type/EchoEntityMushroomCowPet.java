...
import com.dsh105.echopet.api.entity.entitypet.type.EntityMushroomCowPet;
import com.dsh105.echopet.api.entity.pet.type.MushroomCowPet;
...
public class EchoEntityMushroomCowPet extends EntityMushroomCow implements IAnimal, EchoEntityPetHandle, EntityMushroomCowPet {

    private EntityPetModifier<MushroomCowPet> modifier;

    public EchoEntityMushroomCowPet(World world) {
        super(world);
    }

    public EchoEntityMushroomCowPet(World world, MushroomCowPet pet) {
        super(world);
    ...
    @Override
    public MushroomCowPet getPet() {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<MushroomCowPet> getModifier() {
        return modifier;
    }
