...
public abstract class EquipablePetBase<T extends LivingEntity, S extends EntityEquipablePet> extends PetBase<T, S> implements EquipablePet<T, S> {

    protected EquipablePetBase(Player owner) {
        super(owner);
    }
