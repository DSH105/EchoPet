...
import com.dsh105.echopetv3.api.entity.entitypet.type.EntitySnowmanPet;
import com.dsh105.echopetv3.api.entity.pet.PetBase;
import org.bukkit.entity.Player;
import org.bukkit.entity.Snowman;

@PetInfo(type = PetType.SNOWMAN, width = 0.4F, height = 1.8F)
public class SnowmanPetBase extends PetBase<Snowman, EntitySnowmanPet> implements SnowmanPet {

    public SnowmanPetBase(Player owner) {
        super(owner);
    }
