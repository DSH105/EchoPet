...
import com.dsh105.echopetv3.api.entity.entitypet.type.EntityCreeperPet;
import com.dsh105.echopetv3.api.entity.pet.PetBase;
import org.bukkit.entity.Creeper;
import org.bukkit.entity.Player;

@PetInfo(type = PetType.CREEPER, width = 0.6F, height = 1.9F)
public class CreeperPetBase extends PetBase<Creeper, EntityCreeperPet> implements CreeperPet {

    public CreeperPetBase(Player owner) {
        super(owner);
    }
