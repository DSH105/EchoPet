...
import com.dsh105.echopetv3.api.entity.entitypet.type.EntityZombiePet;
...
public class ZombiePetBase<T extends Zombie, S extends EntityZombiePet> extends EquipablePetBase<T, S> implements ZombiePet<T, S> {

    public ZombiePetBase(Player owner) {
        super(owner);
