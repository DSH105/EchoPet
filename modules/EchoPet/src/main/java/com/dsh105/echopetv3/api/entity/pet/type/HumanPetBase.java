...
import com.dsh105.echopetv3.api.entity.pet.EquipablePetBase;
...
public class HumanPetBase extends EquipablePetBase<HumanEntity, EntityHumanPet> implements HumanPet {

    private static final byte ENTITY_STATUS_INVISIBLE = 32;
    private static final byte ENTITY_STATUS_SPRINTING = 32;
    private static final byte ENTITY_STATUS_SNEAKING = 32;
    private static final byte ENTITY_STATUS_DEFAULT = 32;
    ...
    public HumanPetBase(Player owner) {
        super(owner);
