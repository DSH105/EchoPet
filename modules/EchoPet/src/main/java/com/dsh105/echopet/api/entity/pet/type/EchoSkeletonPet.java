...
public class EchoSkeletonPet extends EchoEquipablePet<Skeleton, EntitySkeletonPet> implements SkeletonPet {

    public EchoSkeletonPet(Player owner) {
        super(owner);
    }
    ...
    public void setSkeletonType(Skeleton.SkeletonType type) {
        this.setWither(type == Skeleton.SkeletonType.WITHER);
    }

    @Override
    public Skeleton.SkeletonType getSkeletonType() {
        return isWither() ? Skeleton.SkeletonType.WITHER : Skeleton.SkeletonType.NORMAL;
    }
