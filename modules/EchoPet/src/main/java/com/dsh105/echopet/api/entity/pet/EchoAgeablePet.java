...
public abstract class EchoAgeablePet<T extends Ageable, S extends EntityAgeablePet> extends PetBase<T, S> implements AgeablePet<T, S> {

    protected EchoAgeablePet(Player owner) {
        super(owner);
