...
public class PetEntityListener implements Listener {
    ...
    public void onDismount(VehicleExitEvent event) {
        ...
        if (BukkitUnwrapper.getInstance().unwrap(e) instanceof EntityPet) {
            EntityPet entityPet = (EntityPet) BukkitUnwrapper.getInstance().unwrap(e);
    ...
    public void onBlockForm(EntityBlockFormEvent event) {
        Entity e = event.getEntity();
        if (BukkitUnwrapper.getInstance().unwrap(e) instanceof EntityPet && event.getNewState().getType().equals(Material.SNOW)) {
            event.setCancelled(true);
