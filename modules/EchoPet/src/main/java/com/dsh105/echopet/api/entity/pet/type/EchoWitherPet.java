...
public class EchoWitherPet extends EchoRangedPet<Wither, EntityWitherPet> implements WitherPet {

    public EchoWitherPet(Player owner) {
        super(owner);
    }
    ...
    public void onLive() {
        ...
        if (isShielded()) {
            ...
            getBukkitEntity().setHealth(150F);
        } else if (getBukkitEntity().getHealth() <= getBukkitEntity().getMaxHealth()) {
