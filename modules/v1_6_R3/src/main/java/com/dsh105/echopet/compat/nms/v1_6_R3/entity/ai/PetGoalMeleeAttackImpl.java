...
import com.dsh105.echopet.compat.api.ai.PetGoalMeleeAttack;
...
public class PetGoalMeleeAttackImpl extends PetGoalMeleeAttack {
    ...
    public PetGoalMeleeAttackImpl(EntityPetImpl pet, double lockRange, int ticksBetweenAttack) {
        this.pet = pet;
    ...
    public boolean shouldContinue() {
        ...
        if (entityliving == null) {
            ...
            return false;
        } else if (this.pet.e(((CraftPlayer) this.pet.getPlayerOwner()).getHandle()) >= this.pet.getSizeCategory().teleportDistance(this.pet.getPet().getPetType())) {
            return false;
        }
        return true;
    }
