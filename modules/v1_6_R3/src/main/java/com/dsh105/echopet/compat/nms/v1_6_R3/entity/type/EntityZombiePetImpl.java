...
@EntityPetData(petType = PetType.ZOMBIE)
public class EntityZombiePetImpl extends EntityPetImpl implements EntityZombiePet {

    public EntityZombiePetImpl(World world) {
        super(world);
    }

    public EntityZombiePetImpl(World world, Pet pet) {
        super(world, pet);
        new BukkitRunnable() {
            @Override
            public void run() {
