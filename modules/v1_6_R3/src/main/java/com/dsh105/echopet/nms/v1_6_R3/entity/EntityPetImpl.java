...
package com.dsh105.echopet.nms.v1_6_R3.entity;
...
import com.dsh105.echopet.nms.v1_6_R3.entity.ai.PetGoalFloatImpl;
import com.dsh105.echopet.nms.v1_6_R3.entity.ai.PetGoalFollowOwnerImpl;
import com.dsh105.echopet.nms.v1_6_R3.entity.ai.PetGoalLookAtPlayerImpl;
...
public abstract class EntityPetImpl extends EntityCreature implements IAnimal, EntityPet {
    ...
    private void initiateEntityPet() {
        ...
        this.jumpHeight = PetSettings.JUMP_HEIGHT.getValue(this.getPet().getPetType().storageName());
        this.rideSpeed = PetSettings.RIDE_SPEED.getValue(this.getPet().getPetType().storageName());
        this.setPathfinding();
    }
    ...
    public void onLive() {
        ...
        if (this.getPlayerOwner().isFlying() && PetSettings.CAN_FLY.getValue(this.getPet().getPetType().storageName())) {
