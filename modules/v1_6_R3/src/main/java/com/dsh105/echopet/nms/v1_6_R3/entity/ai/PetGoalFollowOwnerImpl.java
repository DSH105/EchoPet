...
package com.dsh105.echopet.nms.v1_6_R3.entity.ai;

import com.dsh105.echopet.api.ai.PetGoalFollowOwner;
import com.dsh105.echopet.api.ai.PetGoalType;
import com.dsh105.echopet.api.event.PetMoveEvent;
import com.dsh105.echopet.api.plugin.EchoPet;
import com.dsh105.echopet.nms.v1_6_R3.entity.EntityPetImpl;
import com.dsh105.echopet.nms.v1_6_R3.entity.type.EntityGhastPetImpl;
...
public class PetGoalFollowOwnerImpl extends PetGoalFollowOwner {
    ...
    public PetGoalFollowOwnerImpl(EntityPetImpl pet, double startDistance, double stopDistance, double teleportDistance) {
        this.pet = pet;
    ...
    public boolean shouldContinue() {
        ...
        PetGoalMeleeAttackImpl attackGoal = (PetGoalMeleeAttackImpl) this.pet.petGoalSelector.getGoal("Attack");
    ...
    public void tick() {
        ...
        if (--this.timer <= 0) {
            ...
            if (pet.goalTarget == null) {
                if (pet instanceof EntityGhastPetImpl) {
