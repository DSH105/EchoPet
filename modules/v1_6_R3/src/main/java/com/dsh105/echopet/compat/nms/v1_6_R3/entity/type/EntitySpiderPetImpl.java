...
import com.dsh105.echopet.compat.api.entity.nms.type.EntitySpiderPet;
...
@EntityPetData(petType = PetType.SPIDER)
public class EntitySpiderPetImpl extends EntityPetImpl implements EntitySpiderPet {

    public EntitySpiderPetImpl(World world) {
        super(world);
    }

    public EntitySpiderPetImpl(World world, Pet pet) {
        super(world, pet);
    }
