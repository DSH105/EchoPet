...
import com.dsh105.echopet.compat.api.ai.PetGoalLookAtPlayer;
...
public class PetGoalLookAtPlayerImpl extends PetGoalLookAtPlayer {
    ...
    public PetGoalLookAtPlayerImpl(EntityPetImpl pet, Class c) {
        this.pet = pet;
        this.range = 8.0F;
        this.chance = 0.1F;
        this.clazz = c;
    ...
    public PetGoalLookAtPlayerImpl(EntityPetImpl pet, Class c, float f, float f1) {
        this.pet = pet;
        this.range = f;
        this.chance = f1;
        this.clazz = c;
