...
@EntityPetData(petType = PetType.HORSE)
public class EntityHorsePetImpl extends EntityAgeablePetImpl implements EntityHorsePet {

    private int rearingCounter = 0;
    int bP = 0;

    public EntityHorsePetImpl(World world) {
        super(world);
    }

    public EntityHorsePetImpl(World world, Pet pet) {
        super(world, pet);
    }
