...
import com.dsh105.echopet.compat.nms.v1_7_R1.entity.ai.PetGoalFloatImpl;
import com.dsh105.echopet.compat.nms.v1_7_R1.entity.ai.PetGoalFollowOwnerImpl;
import com.dsh105.echopet.compat.nms.v1_7_R1.entity.ai.PetGoalLookAtPlayerImpl;
...
public abstract class EntityPetImpl extends EntityCreature implements IAnimal, EntityPet {
    ...
    public void onLive() {
        ...
        if (this.getPlayerOwner().isFlying() && PetSettings.CAN_FLY.getValue(getPet().getPetType().storageName())) {
    ...
    public void e(float sideMot, float forwMot) {
        ...
        if (FIELD_JUMP != null && this.passenger != null) {
            if (PetSettings.CAN_FLY.getValue(pt)) {
                try {
