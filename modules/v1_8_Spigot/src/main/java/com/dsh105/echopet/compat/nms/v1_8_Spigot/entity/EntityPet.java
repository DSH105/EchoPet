...
import com.dsh105.echopet.compat.nms.v1_8_Spigot.entity.ai.PetGoalFloat;
import com.dsh105.echopet.compat.nms.v1_8_Spigot.entity.ai.PetGoalFollowOwner;
import com.dsh105.echopet.compat.nms.v1_8_Spigot.entity.ai.PetGoalLookAtPlayer;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet {
    ...
    private void initiateEntityPet() {
        ...
        if (FIELD_JUMP == null) {
            try {
                FIELD_JUMP = EntityLiving.class.getDeclaredField("bc");
